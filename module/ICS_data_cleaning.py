...
incident_file = os.path.join('input data','209-PLUS','ics209-plus-wildfire','ics209-plus-wildfire','ics209-plus-wf_incidents_1999to2014.csv')
...
preprocessed_file = os.path.join('input data','ICS_filtered_preprocessed_combined_data.csv')
...
incident_summary_df.to_csv(os.path.join('input data','summary_reports_cleaned.csv'))

...
csv_file_name = "LLIS datasheets/train_set_expanded_H.csv" 
name = "" #optional, used at beginning of folder for identification
#optional, can use optomize instead
...
test.lda_optimization(min_cf=1, max_topics = 200)

...
file = smart_nlp_path+r"\output data\ICS_fullset_combinedtopics-Mar-05-2021\preprocessed_data.csv"
...
ICS.ngrams = "custom"
ICS.data_df = ICS.data_df[:5000].reset_index(drop=True)
#ICS.extract_preprocessed_data(smart_nlp_path+r"\output data\ICS_TEST_full_topics-Feb-25-2021-\preprocessed_data.csv")

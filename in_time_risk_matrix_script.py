...
input_reports = pd.read_csv(os.path.join(os.path.dirname(os.getcwd()),'smart_nlp','data','ICS_data','ICS_val_sitreps_preprocessed.csv')).drop(["Unnamed: 0"], axis=1)
...
file = os.path.join(os.path.dirname(os.getcwd()),'smart_nlp','data', 'ICS_data','ICS_predictive_sitreps_full.csv')
...
summary_reports = pd.read_csv(os.path.join(os.path.dirname(os.getcwd()),'smart_nlp','data','ICS_data','ICS_predictive_summaryreps_full.csv'))
...
"""
val =  pd.read_csv(os.path.join(os.path.dirname(os.getcwd()),'smart_nlp','data','ICS_data','ICS_val_sitreps_preprocessed.csv')).drop(["Unnamed: 0"], axis=1)
train =  pd.read_csv(os.path.join(os.path.dirname(os.getcwd()),'smart_nlp','data','ICS_data','ICS_test_sitreps_preprocessed.csv')).drop(["Unnamed: 0"], axis=1)
test =  pd.read_csv(os.path.join(os.path.dirname(os.getcwd()),'smart_nlp','data','ICS_data','ICS_train_sitreps_preprocessed.csv')).drop(["Unnamed: 0"], axis=1)

...
#input_reports = pd.read_csv(os.path.join(os.path.dirname(os.getcwd()),'data',"likelihood_model_input_test.csv"))
#input_reports = input_reports.iloc[50:52][:].drop(["Unnamed: 0"], axis=1).reset_index(drop=True)
...
input_reports = input_reports.iloc[50:52][:].reset_index(drop=True)

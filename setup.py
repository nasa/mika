...
setup(
    ...
    download_url="https://github.com/nasa/mika/archive/refs/tags/v1.0.3.tar.gz",
    ...
    python_requires='>=3.8',
    install_requires=[
        'BERTopic', 'datasets', 'gensim', 'matplotlib', 'nltk', 'numpy', 'octis', 'openpyxl', 'pandas',
        'pathlib', 'pingouin', 'pyLDAvis', 'regex', 'scikit-learn', 'scipy', 'seaborn',
        'sentence-transformers', 'spacy', 'symspellpy==6.7.0', 'tomotopy', 'transformers', 'wordcloud'
        ]
)
...
if __name__ == '__main__':
    ...
    model_checkpoint = os.path.join(os.path.abspath(os.path.join(os.getcwd(), os.pardir, os.pardir, os.pardir, os.pardir)),"models", "FMEA-ner-model", "checkpoint-1424")
    ...
    fmea.display_doc(doc_id="21-0098", save=True, output_path="test", colors_path=os.path.join(os.path.abspath(os.path.join(os.getcwd(), os.pardir, os.pardir, os.pardir, os.pardir)),'data','doccano','NER_label_config.json'))
    #"""

...
from mika.kd.NER import read_doccano_annots, clean_doccano_annots
...
s = []
for i in range(3):
    file1 = os.path.join(os.path.abspath(os.path.join(os.getcwd(), os.pardir, os.pardir, os.pardir, os.pardir)), llis_H_files[i])
    file2 = os.path.join(os.path.abspath(os.path.join(os.getcwd(), os.pardir, os.pardir, os.pardir, os.pardir)), llis_S_files[i])
...
H_safecom, S_safecom = prepare_annot_dfs(file1=os.path.join(os.path.abspath(os.path.join(os.getcwd(), os.pardir, os.pardir, os.pardir, os.pardir)), 'data','doccano','annotations','hswalsh_safecom_round2.jsonl'),
                                         file2=os.path.join(os.path.abspath(os.path.join(os.getcwd(), os.pardir, os.pardir, os.pardir, os.pardir)), 'data','doccano','annotations','srandrad_safecom_v2.jsonl'))
